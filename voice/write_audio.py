...
def write_temp_audio(username):
    ...
    with sr.Microphone() as source:
        ...
        while True:
            ...
            printf("Please say the following words:")
            printf(" ".join(words))
            ...
            if check:
                ...
                printf("Your words did not match. Please repeat the words.")
                printf(words)
                continue
...
def record_noise():
    ...
    """
    printf("Please stay silent as we record the background noise of your current surroundings.")
    ...
    printf("Recording background noise...")
    frames = []
    for i in range(0, int(44100 /1024*5)):
        data = stream.read(1024)
        frames.append(data)
    printf("Finished recording background noise.")
